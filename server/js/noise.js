...
var fs = require('fs')
var code = fs.readFileSync(__dirname + '/seedrandom.min.js', 'utf-8');
eval(code);
code = fs.readFileSync(__dirname + '/common.js', 'utf-8');
eval(code);
code = fs.readFileSync(__dirname + '/value.js', 'utf-8');
eval(code);
code = fs.readFileSync(__dirname + '/perlin.js', 'utf-8');
eval(code);
code = fs.readFileSync(__dirname + '/simplex.js', 'utf-8');
eval(code);
...
exports.Noise = {
	...
	update: function(data) {
		...
		console.log('Generating Noise with these args...');
		console.log(args);
		// seed random
