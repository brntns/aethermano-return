var movement = {
  ...
  slashat: function slashat() {
    ...
    //this.slashTimer = this.game.time.events.add(this.slashTime,function(){this.resetB(this.slashing);this.resetB(this.hitbox.visible);},this);
  }
};
